...
import 'package:movieapp/presentation/journeys/movie_carousel/movie_card_widget.dart';

import '../../../commom/constants/size_constants.dart';
import '../../../commom/screenutil/screenutil.dart';
    ...
    return Container(
      ...
      child: PageView.builder(
        ...
        itemBuilder: (context, index) {
         ...
         // return MovieCardWidget(movieId: movie.id, posterPath: movie.posterPath.toString());
